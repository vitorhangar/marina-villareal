...
<section class="seguranca" id="seguranca">
    <div class="container">
        <div class="seguranca__box" <?php if(!wp_is_mobile()){ echo 'data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-offset="-230" data-aos-duration="500"';} ?> >
            <div class="seguranca-top">
                <div class="seguranca__box__content">
                    <div class="seguranca__box__content__image">
                        <div class="slider">
