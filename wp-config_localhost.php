...
define( 'DB_NAME', 'villareal-marina' );

/** Usuário do banco de dados MySQL */
define( 'DB_USER', 'hangar-02' );
...
define('WP_HOME', 'http://' . $_SERVER['SERVER_NAME'] . '/villareal-marina/site');
define('WP_SITEURL', WP_HOME);

/** Alterando localização do diretório wp-content */
define('WP_CONTENT_DIR', $_SERVER['DOCUMENT_ROOT'] . '/villareal-marina/site/site');
