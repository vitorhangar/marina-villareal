...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function __construct() {
			...
			add_action( 'get_footer',         		  array( $this, 'scripts' ),       10 );
			add_action( 'get_footer',         		  array( $this, 'child_scripts' ), 30 ); // After WooCommerce.
			add_filter( 'body_class',                 array( $this, 'body_classes' ) );
			add_filter( 'wp_page_menu_args',          array( $this, 'page_menu_args' ) );
			add_filter( 'navigation_markup_template', array( $this, 'navigation_markup_template' ) );
			add_action( 'get_footer',      			  array( $this, 'print_embed_styles' ) );
		}
		...
		public function scripts() {
			 ...
			 * Styles
			 */
			wp_enqueue_style( 'storefront-style', get_template_directory_uri() . '/assets/css/base.css', '', $storefront_version );
